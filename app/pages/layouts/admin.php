...
<div class="wrapper">
    ...
    <header class="main-header">
        <!-- Logo -->
        <a href="<?=siteUrl()?>" target="_blank" class="logo">
            <!-- mini logo for sidebar mini 50x50 pixels -->
            <span class="logo-mini"><b>B</b>S</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>BSHOP</b></span>
        </a>
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                ...
                                <p>
                                    <?=$_SESSION['user']['name'];?>
                                    <small>Role: <?=$_SESSION['user']['role'];?></small>
                                </p>
                            </li>
                            <!-- Menu Footer-->
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li><a href="<?= ADMIN ?>/langs"><i class="fa fa-language"></i> <span>Языки</span></a></li>
            </ul>
        </section>
        <!-- /.sidebar -->
    </aside>
    ...
    <div class="content-wrapper">
        <?php require __DIR__ . '/shared/session-messages.php';?>
        <?=$content;?>
    </div>
    <!-- /.content-wrapper -->
