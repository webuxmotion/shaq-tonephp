...
<section class="content">
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box">
                <form action="<?=ADMIN;?>/product/add" method="post" id="add" data-toggle="validator">
                    <?php
                        $f_itemsArr = ['title', 'keywords', 'description', 'price', 'old_price', 'content'];
                        foreach ($f_itemsArr as $item) {
                            ${"f_$item"} = isset($_SESSION['form_data']) ? h($_SESSION['form_data'][$item]) : null;
                        }
                    ?>
